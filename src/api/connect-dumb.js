...
function _connectDumb(mapProps, module, watchedKeys, connect, state, setup, bindCtxToMethod, mapState, alias, Dumb, props) {
  ...
  return React.createElement(CcFragment, { key: props.key, ccKey: props.ccKey, props, module, watchedKeys, connect, state, setup, bindCtxToMethod, render });
}
...
export default ({ mapProps, mapState, module, watchedKeys, connect, state = {}, setup, bindCtxToMethod, alias = {} }) => Dumb => {
  ...
  const ConnectedFragment = props => _connectDumb(mapProps, module, watchedKeys, connect, clonedState, setup, bindCtxToMethod, mapState, alias, Dumb, props);
