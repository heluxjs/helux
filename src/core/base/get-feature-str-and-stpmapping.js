 ...
 */
export default function getFeatureStrAndStpMapping(connectSpec, fragmentModule) {
  ...
  return { featureStr: fragmentModule + '/' + featureStrs.join('|'), stateToPropMapping, connectedModuleNames: moduleNames };
}