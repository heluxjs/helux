...
export const ERR_MESSAGE = {
  ...
  [ERR.CC_MODULE_REDUCER_INVALID]: `argument moduleReducer is invalid, must be a plain json object!`,
  [ERR.CC_OPTION_REDUCER_INVALID]: `option.reducer is invalid, must be a plain json object(not an array also)!`,
  [ERR.CC_OPTION_REDUCER_FVALUE_INVALID]: `option.reducer's field-value is invalid, must be a plain json object(not an array also)!`,
