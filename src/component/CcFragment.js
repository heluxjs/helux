...
export default class CcFragment extends Component {
  constructor(props, context) {
    ...
    let { ccKey, connect: connectSpec = {} } = props;
    ...
    helper.buildCcClassContext(ccClassKey, MODULE_DEFAULT, [], [], [], [], stateToPropMapping, true);
    ...
    const ccState = {
      module: MODULE_DEFAULT, ccClassKey, ccKey, ccUniqueKey, isCcUniqueKeyAutoGenerated, stateToPropMapping, renderCount: 0
    };
    this.cc = {
      ccState,
