...
function getFragmentClassKeyAndStpMapping(connectSpec) {
  ...
  const { featureStr, stateToPropMapping, connectedModuleNames } = getFeatureStrAndStpMapping(connectSpec);
...
export default class CcFragment extends Component {
  constructor(props, context) {
    ...
    const { ccClassKey, stateToPropMapping, connectedModuleNames } = getFragmentClassKeyAndStpMapping(connectSpec);
