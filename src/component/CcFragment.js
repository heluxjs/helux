...
function getFragmentClassKeyAndStpMapping(connectSpec, fragmentModule, sharedStateKeys) {
  ...
  const { featureStr, stateToPropMapping, connectedModuleNames } = getFeatureStrAndStpMapping(connectSpec, fragmentModule, sharedStateKeys);
...
export default class CcFragment extends Component {
  constructor(props, context) {
    ...
    const { ccClassKey, stateToPropMapping, connectedModuleNames } = getFragmentClassKeyAndStpMapping(connectSpec, fragmentModule, sharedStateKeys);
