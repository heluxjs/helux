...
exports["default"] = exports.defWatch = exports.defComputedVal = exports.defLazyComputed = exports.defComputed = exports.useConcent = exports.appendState = exports.cst = exports.Ob = exports.CcFragment = exports.clearContextIfHot = exports.reducer = exports.getRefs = exports.executeAll = exports.execute = exports.ccContext = exports.dispatch = exports.off = exports.emit = exports.getComputed = exports.getGlobalState = exports.getState = exports.setValue = exports.set = exports.setState = exports.setGlobalState = exports.configure = exports.registerHookComp = exports.registerDumb = exports.register = exports.connectDumb = exports.connect = exports.run = exports.cloneModule = void 0;
...
function avoidMultiCcInSameScope() {
  ...
  if (winCc) {
    if (winCc.ccContext && winCc.ccContext.info) {
      ...
      var newVersion = ccContext.info.version; //webpack-dev-server模式下，有些引用了concent的插件或者中间件模块，如果和当前concent版本不一致的话，会保留另外一个concent在其包下
