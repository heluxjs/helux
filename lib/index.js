...
exports["default"] = exports.defWatchImmediate = exports.defWatch = exports.defComputedVal = exports.defLazyComputed = exports.defComputed = exports.useConcent = exports.appendState = exports.cst = exports.CcFragment = exports.clearContextIfHot = exports.reducer = exports.getRefs = exports.executeAll = exports.execute = exports.createDispatcher = exports.ccContext = exports.dispatch = exports.off = exports.emit = exports.getComputed = exports.getConnectedState = exports.getGlobalState = exports.getState = exports.setValue = exports.set = exports.setState = exports.setGlobalState = exports.configure = exports.registerHookComp = exports.registerDumb = exports.register = exports.connectDumb = exports.connect = exports.run = exports.cloneModule = void 0;
...
var useConcent = _useConcent2["default"]; // 假设用户直接定义的computed函数不超过1000个，让def***定义的computed函数全部在直接定义的computed函数执行后再执行
...
var defComputed = function defComputed(fn, depKeys, defOptions) {
  ...
  return {
    ...
    sort: defOptions.sort || sortFactor++,
