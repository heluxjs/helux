...
var _default = function _default(newModule, existingModule, _temp) {
  ...
  var reducerOriginal = _ccContext["default"].reducer._reducer[existingModule] || {}; // attach  __fnName  __stateModule __reducerModule, 不能污染原函数的dispatch逻辑里需要的__stateModule __reducerModule
