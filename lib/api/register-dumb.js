...
function _default(registerOption, ccClassKey) {
  ...
  var passToMapWaKeys = util.getPassToMapWaKeys(watchedKeys);

  var _mapRegistrationInfo = (0, _mapRegistrationInfo2["default"])(module, ccClassKey, renderKeyClasses, _constant.CC_FRAGMENT, passToMapWaKeys, storedKeys, connect, true),
