...
function _default(module, state, renderKey, delayMs, skipMiddleware, throwError) {
  if (delayMs === void 0) {
    delayMs = -1;
  }
  ...
  (0, _setState["default"])(module, state, renderKey, delayMs, skipMiddleware, throwError);
}