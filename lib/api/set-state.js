...
function _default(module, state, delayMs, renderKey, skipMiddleware, throwError) {
  if (delayMs === void 0) {
    delayMs = -1;
  }
  ...
  (0, _setState["default"])(module, state, delayMs, renderKey, skipMiddleware, throwError);
}