...
function _default(_temp) {
  ...
  try {
    ...
    bindToWindow('CC_CONTEXT', _ccContext["default"]);
    bindToWindow('ccc', _ccContext["default"]);
    bindToWindow('cccc', _ccContext["default"].computed._computedValue);
    bindToWindow('sss', _ccContext["default"].store._state);
