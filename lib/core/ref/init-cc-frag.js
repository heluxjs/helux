...
function _default(ref, props) {
  ...
  if (props.__$$regDumb !== true) {
    ...
    var _mapRegistrationInfo = (0, _mapRegistrationInfo2["default"])(module, ccClassKey, renderKeyClasses, _constant.CC_CLASS, watchedKeys, connect, true),
