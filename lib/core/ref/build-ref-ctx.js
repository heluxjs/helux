...
function _default(ref, params, liteLevel) {
  ...
  var ccUniqueKey = (0, _computeCcUniqueKey["default"])(isSingle, ccClassKey, ccKey, ccOption.tag || tag); // 没有设定renderKey的话，默认ccUniqueKey就是renderKey
  ...
  var dispatch = hf.makeDispatchHandler(ref, false, false, stateModule, stateModule);
