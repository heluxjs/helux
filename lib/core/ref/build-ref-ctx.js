...
var getConnectWatchedKeys = function getConnectWatchedKeys(ctx, module) {
  ...
  var getWKeys = function getWKeys(module) {
    if (isConnectArr) {
      ...
      if (waKeys === '*') return moduleName_stateKeys_[module];else if (waKeys === '-') return ctx.__$$preparedConnectWatchedKeys_[module];else return waKeys;
    }
  };
...
function _default(ref, params, liteLevel) {
  ...
  if (!__$$noAutoWatch) {
    ...
    ctx.__$$getEmptyCMWKeys = function () {
      return clone(ctx.__$$emptyCMWKeys);
    };
  }
