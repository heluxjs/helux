...
function _default(ref, params, liteLevel) {
  ...
  var ccUniqueKey = (0, _computeCcUniqueKey["default"])(isSingle, ccClassKey, ccKey, refOption.tag); // 没有设定renderKey的话读id，最后才默认renderKey为ccUniqueKey
  ...
  var moduleState = module === _constant.MODULE_GLOBAL ? globalState : (0, _makeObState["default"])(ref, mstate, module, true); // record ccClassKey
