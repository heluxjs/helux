...
function setCcInstanceRef(ccUniqueKey, ref, ccKeys, option, delayMs) {
  function setRef() {
    ...
    _ccContext["default"].ccUkey_option_[ccUniqueKey] = option;
  }
...
function _default(ref, isSingle, ccClassKey, ccKey, ccUniqueKey, ccOption) {
  ...
  if (!_util["default"].isCcOptionValid(ccOption)) {
    throw me(_constant.ERR.CC_CLASS_INSTANCE_OPTION_INVALID, vbi("a standard default ccOption may like: {\"storedKeys\": []}"));
  }
