...
function prepareReactSetState(targetRef, identity, calledBy, state, stateFor, next, reactCallback) {
  ...
  if (storedStateKeys.length > 0) {
    var _extractStateByKeys = (0, _extractStateByKeys5["default"])(state, storedStateKeys),
    ...
    if (!isStateEmpty) {
      if (ccOption.storeInLocalStorage === true) {
        var _extractStateByKeys2 = (0, _extractStateByKeys5["default"])(thisState, storedStateKeys),
    ...
    if (ccClassKeys) {
      ...
      ccClassKeys.forEach(function (ccClassKey) {
        ...
        if (originalSharedStateKeys === '*') {
          ...
          var _extractStateByKeys4 = (0, _extractStateByKeys5["default"])(partialSharedState, sharedStateKeys, true),
