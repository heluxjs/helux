...
var isPlainJsonObject = util.isPlainJsonObject,
    ...
    okeys = util.okeys,
    removeArrElements = util.removeArrElements;
...
function triggerReactSetState(targetRef, callInfo, renderKey, calledBy, state, stateFor, reactCallback) {
  ...
  (0, _computeValueForRef["default"])(refCtx, stateModule, refState, state, callInfo);
  var shouldCurrentRefUpdate = (0, _watchKeyForRef["default"])(refCtx, stateModule, refState, state, callInfo);
...
function syncCommittedStateToStore(moduleName, committedState, options) {
  ...
  var _extractStateByKeys3 = (0, _extractStateByKeys5["default"])(committedState, stateKeys, true),
    ...
    if (isSetConnectedStateTriggered === true) {
      ...
      ccKeys.forEach(function (ccUniKey) {
        ...
        if (ref && ref.__$$isUnmounted !== true) {
          var refCtx = ref.ctx;
          (0, _computeValueForRef["default"])(refCtx, targetModule, prevModuleState, sharedState, callInfo);
          var shouldCurrentRefUpdate = (0, _watchKeyForRef["default"])(refCtx, targetModule, prevModuleState, sharedState, callInfo);
