...
function _default(module, reducer, rootReducerCanNotContainInputModule, tag) {
  ...
  var subReducerCaller = util.safeGetObjectFromObject(_reducerCaller, module); // const subReducerRefCaller = util.safeGetObjectFromObject(_reducerRefCaller, module);
