      ...
      if (module_mapAllStateToProp_[module] === true) {
        ...
        moduleStateKeys.forEach(function (msKey) {
          ...
          if (appeared === true) {
            ...
            (0, _setPropState["default"])(propState, derivedPropKey, moduleState[msKey], isPropStateModuleMode, module);
            isPropStateSet = true;
          }
        });
      } else {
        ...
        _prefixedKeys.forEach(function (prefixedKey) {
          ...
          if (appeared === true) {
            ...
            (0, _setPropState["default"])(propState, derivedPropKey, moduleState[stateKey], isPropStateModuleMode, module);
            isPropStateSet = true;
          }
        });
      }
