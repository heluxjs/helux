  ...
  if (stateToPropMapping) {
    Object.keys(state).forEach(function (sKey) {
      ...
      if (moduledPropKeyDescriptor) {
        ...
        (0, _setPropState.default)(propState, originalPropKey, stateValue, isPropStateModuleMode, stateModuleName);
      ...
      function (_TargetClass) {
        ...
        function CcClass(props, context) {
          ...
          try {
            ...
            _util.default.bindThis((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), ['__$$mapCcToInstance', '$$changeState', '__$$recoverState', '$$domDispatch', '__$$getChangeStateHandler', '__$$getEffectHandler', '__$$getLazyEffectHandler', '__$$getXEffectHandler', '__$$getLazyXEffectHandler', '__$$getDispatchHandler', '__$$getEffectIdentityHandler', '__$$getXEffectIdentityHandler']);
            ...
            var ccClassContext = ccClassKey_ccClassContext_[ccClassKey];
            (0, _setRef.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), isSingle, ccClassKey, newCcKey, ccUniqueKey, ccOption);
        ...
        _proto.$$domDispatch = function $$domDispatch(event) {
          ...
          var handler = this.__$$getDispatchHandler(_constant.STATE_FOR_ONE_CC_INSTANCE_FIRSTLY, module, reducerModule, type, payload, cclazyms, ccKey, ccidt);
