...
var _extractStateByCcsync2 = _interopRequireDefault(require("./extract-state-by-ccsync"));
    ...
    return function (ReactClass) {
      ...
      function (_TargetClass) {
            ...
            __invokeWith: function __invokeWith(userLogicFn, executionContext) {
              ...
              isStateModuleValid(targetModule, currentModule, cb, function (err, newCb) {
                ...
                if (context) {
                  ...
                  var dispatchIdentity = _this3.__$$getDispatchHandler(_constant.STATE_FOR_ALL_CC_INSTANCES_OF_ONE_MODULE, targetModule, reducerModule, null, null, delay, ccKey, identity);
              ...
              if (storedStateKeys.length > 0) {
                ...
                if (!isStateEmpty) {
                  if (ccOption.storeInLocalStorage === true) {
                    var _extractStateByKeys6 = (0, _extractStateByKeys11["default"])(_this3.state, storedStateKeys),
          ...
          return function (firstParam) {
            ...
            if (firstParamType === 'function') {
              ...
              var fn = firstParam.fn,
                  option = (0, _objectWithoutPropertiesLoose2["default"])(firstParam, ["fn"]);
        ...
        _proto.$$sync = function $$sync(event, stateFor) {
          ...
          var _extractStateByCcsync = (0, _extractStateByCcsync2["default"])(ccsync, value, ccint, getState(_module)),
