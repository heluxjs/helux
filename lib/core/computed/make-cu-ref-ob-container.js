...
var _computedValueOri = _computedMap["default"]._computedValueOri,
    ...
    _computedRaw = _computedMap["default"]._computedRaw,
    _computedDep = _computedMap["default"]._computedDep; // refModuleCuDep 来自 ref.ctx.computedDep
  ...
  return new Proxy(oriCuContainer, {
    get: function get(target, otherRetKey) {
      ...
      if (hasOwnProperty.call(oriCuContainer, otherRetKey)) {
        if ((0, _util.isAsyncFn)(computedRaw[otherRetKey])) {
        ...
        (0, _util.justWarning)(fnInfo + " get cuVal invalid retKey[" + otherRetKey + "]");
    ...
    get: function get(target, retKey) {
      ...
      if (hasOwnProperty.call(oriCuContainer, retKey)) {
        ...
        if (isRefCu) {
          ...
          (0, _util.okeys)(computedDep).forEach(function (m) {
