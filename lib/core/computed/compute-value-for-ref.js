...
function _default(ref, stateModule, oldState, committedState, callInfo, isBeforeMount, autoMergeDeltaToCommitted) {
  ...
  (0, _findDepFnsToExecute["default"])(ref, stateModule, refModule, oldState, curDepComputedFns, committedState, newState, deltaCommittedState, callInfo, isBeforeMount, 'computed', _constant.CATE_REF, refComputed);
