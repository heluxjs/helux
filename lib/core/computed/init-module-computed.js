...
function _default(module, computed) {
  ...
  (0, _findDepFnsToExecute["default"])(d, module, d && d.ctx.module, moduleState, curDepComputedFns, moduleState, moduleState, deltaCommittedState, util.makeCallInfo(module), true, 'computed', _constant.CATE_MODULE, moduleComputedValue);
}