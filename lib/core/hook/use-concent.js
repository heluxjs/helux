 ...
 */
var ccUKey_ref_ = _ccContext["default"].ccUKey_ref_; // const cursor_hookCtx_ = {};
...
function _useConcent(registerOption, ccClassKey, insType) {
  ...
  var refCtx = hookRef.ctx;
  var effectHandler = layoutEffect ? _react["default"].useLayoutEffect : _react["default"].useEffect; // after first render of hookRef just created 
