...
function buildRef(ref, refKeyContainer, rState, iState, regOpt, hookState, hookSetter, props, extra, ccClassKey) {
  ...
  if (ref) {
    ...
    (0, _setRef["default"])(ref, isSingle, _ccClassKey, ccKey, ccUniqueKey); //单独调用一下此接口记录ref
  ...
  (0, _beforeMount["default"])(hookRef, setup, bindCtxToMethod, isMounted); // cursor_refKey_[cursor] = hookRef.ctx.ccUniqueKey;
