...
function useConcent(registerOption, ccClassKey) {
  ...
  var buildRef = function buildRef() {
    ...
    var _mapRegistrationInfo = (0, _mapRegistrationInfo2["default"])(module, ccClassKey, renderKeyClasses, _constant.CC_HOOK_PREFIX, watchedKeys, storedKeys, connect, true),
