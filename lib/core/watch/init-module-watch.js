...
function _default(module, moduleWatch, append) {
  ...
  var moduleComputedValue = safeGetObject(rootComputedValue, module);
  (0, _findDepFnsToExecute["default"])(d && d.ctx, module, d && d.ctx.module, moduleState, curDepWatchFns, moduleState, moduleState, deltaCommittedState, util.makeCallInfo(module), true, 'watch', _constant.CATE_MODULE, moduleComputedValue);
}