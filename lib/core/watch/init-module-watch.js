...
function _default(module, moduleWatch, append) {
  ...
  (0, _findDepFnsToExecute["default"])(d, module, d && d.ctx.module, moduleState, curDepWatchFns, moduleState, moduleState, deltaCommittedState, util.makeCallInfo(module), true, 'watch', _constant.CATE_MODULE, moduleComputedValue);
}