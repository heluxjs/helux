...
function _default(ref, stateModule, oldState, committedState, callInfo, isBeforeMount) {
  ...
  return (0, _findDepFnsToExecute["default"])(ref, stateModule, refModule, oldState, curDepComputedFns, committedState, newState, deltaCommittedState, callInfo, isBeforeMount, _constant.FN_WATCH, _constant.CATE_REF, computedContainer);
}