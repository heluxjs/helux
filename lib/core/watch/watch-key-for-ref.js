...
function _default(refCtx, stateModule, oldState, committedState, callInfo, isBeforeMount, autoMergeDeltaToCommitted) {
  ...
  var shouldCurrentRefUpdate = (0, _findDepFnsToExecute["default"])(refCtx, stateModule, refModule, oldState, curDepComputedFns, committedState, newState, deltaCommittedState, callInfo, isBeforeMount, 'watch', _constant.CATE_REF, refComputed, refConnectedComputed);
