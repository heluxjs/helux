...
function _default(ref) {
  ...
  if (_modueInsCountMap["default"][module] === 0 && _lifecycle[module].willUnmount) {
    var once = _lifecycle[module].willUnmount((0, _handlerFactory.makeModuleDispatcher)(module), __$$mstate);
