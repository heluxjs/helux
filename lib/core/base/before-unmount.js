...
function _default(ref) {
  ...
  _modueInsCountMap["default"][module] -= 1;

  if (_willUnmountOnce[module] === true) {
    return;
  }

  if (_modueInsCountMap["default"][module] === 0 && _lifecycle[module].lastInsWillUnmount) {
    var once = _lifecycle[module].lastInsWillUnmount((0, _handlerFactory.makeModuleDispatcher)(module), __$$mstate);

    _willUnmountOnce[module] = (0, _util.getVal)(once, true);
  }
}