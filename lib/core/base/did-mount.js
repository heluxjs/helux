...
function _default(ref) {
  ...
  if (_modueInsCountMap["default"][module] == 1 && _lifecycle[module].firstInsMounted) {
    var once = _lifecycle[module].firstInsMounted((0, _handlerFactory.makeModuleDispatcher)(module), __$$mstate);
