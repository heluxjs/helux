...
function _default(ref) {
  ...
  if (hasComputedFn) {
    (0, _computeValueForRef["default"])(ref, refModule, refState, refState, callInfo, true, true);
    connectedModules.forEach(function (m) {
      var mState = getState(m);
      var tmpCallInfo = (0, _util.makeCallInfo)(m);
      (0, _computeValueForRef["default"])(ref, m, mState, mState, tmpCallInfo, true, true);
    });
  }

  if (hasWatchFn) {
    (0, _watchKeyForRef["default"])(ref, refModule, refState, refState, callInfo, true, true);
    connectedModules.forEach(function (m) {
      var mState = getState(m);
      var tmpCallInfo = (0, _util.makeCallInfo)(m);
      (0, _watchKeyForRef["default"])(ref, m, mState, mState, tmpCallInfo, true, true);
    });
  }
}