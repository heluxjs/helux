  ...
  var _loop = function _loop() {
    ...
    pickedFns.forEach(function (_ref) {
      ...
      if (needCollectDep) {
        ...
        fnCtx.cuVal = (0, _makeCuRefObContainer.getSimpleObContainer)(stateModule, collectedCuRetKeys);
      }
      ...
      if (fnType === 'computed') {
        ...
        if (needCollectDep) {
          ...
          setStateKeyRetKeysMap(refCtx, sourceType, _constant.FN_WATCH, stateModule, retKey, collectedDepKeys); // 在watch里读取了cuVal里的retKey结果，要将这些retKey对应的stateKey依赖到当前watch retKey的依赖列表上，
