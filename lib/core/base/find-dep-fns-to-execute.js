...
var _makeLazyComputedHandler = _interopRequireWildcard(require("../computed/make-lazy-computed-handler"));
    ...
    pickedFns.forEach(function (_ref) {
      ...
      if (fnType === 'computed') {
        if (isLazy) {
          ...
          if (cuFn) cuFn(_makeLazyComputedHandler.CLEAR, n, o, fnCtx);else computedContainer[retKey] = (0, _makeLazyComputedHandler["default"])(fn, n, o, fnCtx);
        } else {
