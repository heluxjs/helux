...
function getSuitableGlobalStateKeysAndSharedStateKeys(sharedStrategy, isDispatcher, stateFor, moduleName, ccClassGlobalStateKeys, ccClassSharedStateKeys) {
  ...
  if (sharedStrategy == _constant.SHARE_STATE_BELONG_TO_MODULE || isDispatcher) {
    return {
      ...
      globalStateKeys: moduleName_stateKeys_[_constant.MODULE_GLOBAL] || []
    };
  }
      ...
      function (_TargetClass) {
        ...
        function CcClass(props, context) {
          ...
          try {
            ...
            if (_this.$$watch) {
              _this.cc.watch = _this.$$watch.bind((0, _assertThisInitialized2["default"])(_this));
              _this.cc.watchSpec = (0, _getWatchSpec["default"])(_this.cc.watch);
            }

            if (_this.$$computed) {
              _this.cc.computed = _this.$$computed.bind((0, _assertThisInitialized2["default"])(_this));
              _this.cc.computedSpec = (0, _getComputedSpec["default"])(_this.cc.computed);
            }
        ...
        _proto.$$attach = function $$attach(childRef) {
          ...
          var bindChildRefCcApi = function bindChildRefCcApi(cRef, method, ccMethod) {
            if (cRef[method]) {
              ...
              if (method === '$$watch') _this2.cc.watchSpec = (0, _getWatchSpec["default"])(_this2.cc.$$watch);else if (method === '$$computed') _this2.cc.computedSpec = (0, _getComputedSpec["default"])(_this2.cc.$$computed);
            }
          ...
          var _doChangeState = function _doChangeState() {
            if (module == _constant.MODULE_GLOBAL) {
              ...
              if (module === currentModule) {
                ...
                _this4.cc.prepareBroadcastState(_broadcastInfo, _constant.STATE_FOR_ALL_CC_INSTANCES_OF_ONE_MODULE, btb, module, state, true, delay, identity);
              }
            }
          };
