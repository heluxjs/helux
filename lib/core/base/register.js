      ...
      function (_TargetClass) {
        ...
        _proto.$$sync = function $$sync(e, val, delay, idt) {
          if (typeof e === 'string') {
            ...
            return this.__$$sync.bind(this, (_this$__$$sync$bind3 = {}, _this$__$$sync$bind3[_constant.CCSYNC_KEY] = e, _this$__$$sync$bind3.val = val, _this$__$$sync$bind3.delay = delay, _this$__$$sync$bind3.idt = idt, _this$__$$sync$bind3));
        ...
        _proto.__$$sync = function __$$sync(spec, e) {
          ...
          if (!targetStateFor) {
            targetStateFor = ((0, _readOnlyError2["default"])("targetStateFor"), _module !== currentModule ? _constant.STATE_FOR_ALL_CC_INSTANCES_OF_ONE_MODULE : _constant.STATE_FOR_ONE_CC_INSTANCE_FIRSTLY);
          }
