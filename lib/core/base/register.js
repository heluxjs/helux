...
function register(_temp, ccClassKey) {
  ...
  try {
    var _mapRegistrationInfo = (0, _mapRegistrationInfo2["default"])(module, ccClassKey, renderKeyClasses, _constant.CC_CLASS, inputWatchedKeys, storedKeys, connect, __checkStartUp, __calledBy),
