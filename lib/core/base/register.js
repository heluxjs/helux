    ...
    return function (ReactClass) {
      ...
      function (_ToBeExtendedClass) {
        ...
        _proto.$$attach = function $$attach(childRef) {
          ...
          (0, _injectObState["default"])(childRef); //避免提示 Warning: Expected {Component} state to match memoized state before componentDidMount
        ...
        _proto.render = function render() {
          ...
          if (isPropsProxy === false) {
            if (this.ctx.watchedKeys === '-') (0, _injectObState["default"])(this); //now cc class extends ReactClass, call super.render()
