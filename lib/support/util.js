...
exports.executeCompOrWatch = executeCompOrWatch;
...
function getDupKeys(arr1, arr2) {
  var keys1 = okeys(arr1);
  var keys2 = okeys(arr2);
  var longer = keys2,
      shorter = keys1;
  ...
  var dupKeys = [];
  shorter.forEach(function (k) {
    return longer.includes(k) && dupKeys.push(k);
  });
  return dupKeys;
}
