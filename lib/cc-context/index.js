...
var _findDepFnsToExecute = _interopRequireDefault(require("../core/base/find-dep-fns-to-execute"));
...
var getDispatcher = function getDispatcher() {
  return refs[_constant.CC_DISPATCHER];
};
...
var setStateByModule = function setStateByModule(module, committedState, _temp) {
  ...
  (0, _findDepFnsToExecute["default"])(refCtx, module, refModule, moduleState, curDepComputedFns, toComputedState, newState, deltaCommittedState, callInfo, false, 'computed', _constant.CATE_MODULE, moduleComputedValue);
  (0, _findDepFnsToExecute["default"])(refCtx, module, refModule, moduleState, curDepWatchFns, toComputedState, newState, deltaCommittedState, callInfo, false, 'watch', _constant.CATE_MODULE, moduleComputedValue);
  okeys(deltaCommittedState).forEach(function (key) {
  ...
  */
  ...
  store: {
    appendState: function appendState(module, state) {
      var stateKeys = util.safeGetArrayFromObject(_statekeysMap["default"], module);
