...
var executeCompOrWatch = util.executeCompOrWatch,
    okeys = util.okeys;
var refs = {};
...
var setStateByModule = function setStateByModule(module, committedState, _temp) {
  ...
  if (callInfo.noCW === false && (cLen || wLen)) {
    ...
    if (cLen) {
      var _util$makeCommitHandl = util.makeCommitHandler(module, changeState, callInfo),
      ...
      cFns.forEach(function (_ref2) {
        ...
        var computedValue = executeCompOrWatch(retKey, depKeys, fn, newState, moduleState, fnCtx);
    ...
    if (wLen) {
      var _util$makeCommitHandl2 = util.makeCommitHandler(module, changeState, callInfo),
  ...
  okeys(committedState).forEach(function (key) {
