...
var setStateByModule = function setStateByModule(module, committedState, _temp) {
  ...
  (0, _findDepFnsToExecute["default"])(refCtx, module, refModule, moduleState, curDepComputedFns, stateForComputeFn, newState, deltaCommittedState, callInfo, false, 'computed', _constant.CATE_MODULE, moduleComputedValue);
  (0, _findDepFnsToExecute["default"])(refCtx, module, refModule, moduleState, curDepWatchFns, stateForComputeFn, newState, deltaCommittedState, callInfo, false, 'watch', _constant.CATE_MODULE, moduleComputedValue);
