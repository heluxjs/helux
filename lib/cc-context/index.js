...
var setStateByModule = function setStateByModule(module, committedState, _temp) {
  ...
  (0, _findDepFnsToExecute["default"])(refCtx, module, refModule, moduleState, curDepComputedFns, toComputedState, newState, deltaCommittedState, callInfo, false, 'computed', '', moduleComputedValue);
  (0, _findDepFnsToExecute["default"])(refCtx, module, refModule, moduleState, curDepWatchFns, toComputedState, newState, deltaCommittedState, callInfo, false);
