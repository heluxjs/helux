...
var _modueInsCountMap = _interopRequireDefault(require("./modue-ins-count-map"));
...
var setStateByModule = function setStateByModule(module, committedState, _temp) {
  ...
  var _findDepFnsToExecute = (0, _findDepFnsToExecute3["default"])(callerRef, module, refModule, moduleState, curDepComputedFns, deltaCommittedState, newState, deltaCommittedState, callInfo, false, _constant.FN_CU, _constant.CATE_MODULE, moduleComputedValue),
      hasDeltaInCu = _findDepFnsToExecute.hasDelta;

  var _findDepFnsToExecute2 = (0, _findDepFnsToExecute3["default"])(callerRef, module, refModule, moduleState, curDepWatchFns, deltaCommittedState, newState, deltaCommittedState, callInfo, false, _constant.FN_WATCH, _constant.CATE_MODULE, moduleComputedValue),
...
var ccContext = {
  ...
  */
  ...
  module_insCount_: _modueInsCountMap["default"],
  refs: _refs["default"],
  info: {
