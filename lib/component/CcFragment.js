  ...
  function CcFragment(props, context) {
    ...
    var __fragmentParams = {
      ...
      sync: function sync(e, val, delay, idt) {
        ...
        if (typeof e === 'string') return __sync.bind(null, (_sync$bind2 = {}, _sync$bind2[_constant.CCSYNC_KEY] = _ccsync, _sync$bind2.type = 'val', _sync$bind2.val = val, _sync$bind2.delay = delay, _sync$bind2.idt = idt, _sync$bind2));
