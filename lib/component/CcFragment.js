...
var _changeRefState = _interopRequireDefault(require("../core/state/change-ref-state"));
...
function getFragmentClassKeyAndStpMapping(connectSpec, fragmentModule, watchedKeys) {
  ...
  var _getFeatureStrAndStpM = (0, _getFeatureStrAndStpmapping["default"])(connectSpec, fragmentModule, watchedKeys),
...
function (_React$Component) {
  ...
  function CcFragment(props, context) {
    ...
    var fragmentModule = module || _constant.MODULE_DEFAULT;
    var mergedState = Object.assign(state, getState(fragmentModule));
    ...
    if (ccKey) {
      ...
      var _base$computeCcUnique = base.computeCcUniqueKey(false, ccClassKey, ccKey, true, tag),
    ...
    var moduleState = getState(fragmentModule);
    var moduleComputed = _computedValue[fragmentModule] || {};
    ...
    var __sync = function __sync(spec, e) {
      ...
      var mockE = base.buildMockEvent(spec, e);
    ...
    var __fragmentParams = {
      ...
      defineEffect: function defineEffect(fn, stateKeys, eId, immediate) {
        ...
        var _fn = fn.bind((0, _assertThisInitialized2["default"])(_this), _this.__fragmentParams);
      ...
      dispatch: function dispatch(paramObj, payloadWhenFirstParamIsString, userInputDelay, userInputIdentity) {
        ...
        var d = dispatcher.__$$getDispatchHandler((0, _assertThisInitialized2["default"])(_this), _this.state, false, ccKey, ccUniqueKey, ccClassKey, stateModule, stateModule, null, null, -1);
      ...
      lazyDispatch: function lazyDispatch(paramObj, payloadWhenFirstParamIsString, userInputDelay, userInputIdentity) {
        ...
        var d = dispatcher.__$$getDispatchHandler((0, _assertThisInitialized2["default"])(_this), _this.state, true, ccKey, ccUniqueKey, ccClassKey, stateModule, stateModule, null, null, -1);

        return d(paramObj, payloadWhenFirstParamIsString, userInputDelay, userInputIdentity);
      },
      invoke: dispatcher.__$$getInvokeHandler((0, _assertThisInitialized2["default"])(_this), fragmentModule, ccKey, ccUniqueKey, ccClassKey),
      lazyInvoke: dispatcher.__$$getInvokeHandler((0, _assertThisInitialized2["default"])(_this), fragmentModule, ccKey, ccUniqueKey, ccClassKey, {
        isLazy: true
      }),
      setModuleState: function setModuleState(module, state, delay, identity) {
        ...
        (0, _changeRefState["default"])(_state, {
      ...
      forceUpdate: function forceUpdate(cb, delay, identity) {
        (0, _changeRefState["default"])(_this.state, {
      ...
      changeState: function changeState(state, option) {
        (0, _changeRefState["default"])(state, option, (0, _assertThisInitialized2["default"])(_this));
      }
    };
  ...
  _proto.__beforeMount = function __beforeMount() {
    ...
    var connectModules = okeys(connect);
    ...
    if (computedSpec) {
      ...
      (0, _computeValueForRef["default"])(module, computedSpec, refComputed, refConnectedComputed, thisState, thisState, this.__fragmentParams);
  ...
  _proto.render = function render() {
    ...
    if (typeof view === 'function') {
      ...
      return view(this.__fragmentParams) || _react["default"].createElement('span', {
        style: {
          display: 'none'
        }
      });
