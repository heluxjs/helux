...
var hf = _interopRequireWildcard(require("../core/state/handler-factory"));
...
function (_React$Component) {
  ...
  function CcFragment(props, context) {
    ...
    if (props.__$$regDumb !== true) {
      var _mapRegistrationInfo = (0, _mapRegistrationInfo2["default"])(module, ccClassKey, renderKeyClasses, _constant.CC_FRAGMENT, watchedKeys, storedKeys, connect, true),
