...
var _buildRefCtx = _interopRequireDefault(require("../core/state/build-ref-ctx"));
...
function (_React$Component) {
  ...
  function CcFragment(props, context) {
    ...
    if (props.__$$regDumb !== true) {
      ...
      var _mapRegistrationInfo = (0, _mapRegistrationInfo2["default"])(module, propsCcClassKey, _constant.CC_FRAGMENT_PREFIX, watchedKeys, ccOption.storedKeys, connect, reducerModule, true),
    ...
    (0, _beforeMount["default"])((0, _assertThisInitialized2["default"])(_this), props.setup, props.bindCtxToMethod); // if (props.beforeMount) props.beforeMount(this.ctx);
