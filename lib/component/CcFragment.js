...
function (_React$Component) {
  ...
  function CcFragment(props, context) {
    ...
    if (props.__$$regDumb !== true) {
      ...
      var _mapRegistrationInfo = (0, _mapRegistrationInfo2["default"])(module, propsCcClassKey, _constant.CC_FRAGMENT_PREFIX, watchedKeys, storedKeys, connect, reducerModule, true),
      ...
      (0, _buildRefCtx["default"])((0, _assertThisInitialized2["default"])(_this), props);
    }
