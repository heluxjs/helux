...
function getFragmentClassKeyAndStpMapping(connectSpec, fragmentModule) {
  ...
  var _getFeatureStrAndStpM = (0, _getFeatureStrAndStpmapping["default"])(connectSpec, fragmentModule),
...
function (_Component) {
  ...
  function CcFragment(props, context) {
    ...
    base.buildCcClassContext(ccClassKey, fragmentModule, sharedStateKeys, _sharedStateKeys, stateToPropMapping, connectedModuleNames, true);
