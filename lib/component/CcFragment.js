  ...
  _proto.render = function render() {
    ...
    if (typeof view === 'function') {
      ...
      if (_react["default"].isValidElement(view)) {
        _util["default"].justWarning("you are trying to specify a react dom to be CcFragment's children, it will never been rendered again no matter how your state changed!!!");
      }
