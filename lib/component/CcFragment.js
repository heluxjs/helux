    ...
    var __fragmentParams = {
      ...
      syncmBool: function syncmBool(e, delay, idt) {
        ...
        if (typeof e === 'string') {
          ...
          return __sync.bind(null, (_sync$bind2 = {}, _sync$bind2[_constant.CCSYNC_KEY] = _ccsync, _sync$bind2.type = 'bool', _sync$bind2.delay = delay, _sync$bind2.idt = idt, _sync$bind2));
        }
      ...
      sync: function sync(e, val, delay, idt) {
        ...
        if (typeof e === 'string') return __sync.bind(null, (_sync$bind3 = {}, _sync$bind3[_constant.CCSYNC_KEY] = e, _sync$bind3.type = 'val', _sync$bind3.val = val, _sync$bind3.delay = delay, _sync$bind3.idt = idt, _sync$bind3));
      ...
      syncm: function syncm(e, val, delay, idt) {
        ...
        if (typeof e === 'string') {
          ...
          return __sync.bind(null, (_sync$bind4 = {}, _sync$bind4[_constant.CCSYNC_KEY] = _ccsync, _sync$bind4.type = 'val', _sync$bind4.val = val, _sync$bind4.delay = delay, _sync$bind4.idt = idt, _sync$bind4));
        }
      ...
      setm: function setm(ccsync, val, delay, idt) {
        ...
        __sync((_sync3 = {}, _sync3[_constant.CCSYNC_KEY] = _ccsync, _sync3.type = 'val', _sync3.val = val, _sync3.delay = delay, _sync3.idt = idt, _sync3));
      },
      //对布尔值自动取反
      setBool: function setBool(ccsync, delay, idt) {
        ...
        __sync((_sync4 = {}, _sync4[_constant.CCSYNC_KEY] = ccsync, _sync4.type = 'bool', _sync4.delay = delay, _sync4.idt = idt, _sync4));
      },
      //自动包含模块的setToggle
      setmBool: function setmBool(ccsync, delay, idt) {
        ...
        __sync((_sync5 = {}, _sync5[_constant.CCSYNC_KEY] = _ccsync, _sync5.type = 'bool', _sync5.delay = delay, _sync5.idt = idt, _sync5));
      },
      ...
      syncInt: function syncInt(e, delay, idt) {
        ...
        if (typeof e === 'string') return __sync.bind(null, (_sync$bind5 = {}, _sync$bind5[_constant.CCSYNC_KEY] = e, _sync$bind5.type = 'int', _sync$bind5.delay = delay, _sync$bind5.idt = idt, _sync$bind5));
      ...
      syncmInt: function syncmInt(e, delay, idt) {
        ...
        if (typeof e === 'string') {
          ...
          return __sync.bind(null, (_sync$bind6 = {}, _sync$bind6[_constant.CCSYNC_KEY] = _ccsync, _sync$bind6.type = 'int', _sync$bind6.delay = delay, _sync$bind6.idt = idt, _sync$bind6));
        }
      ...
      dispatch: function dispatch(paramObj, payloadWhenFirstParamIsString, userInputDelay, userInputIdentity) {
        var d = dispatcher.__$$getDispatchHandler(_this.state, false, ccKey, ccUniqueKey, ccClassKey, _constant.STATE_FOR_ALL_CC_INSTANCES_OF_ONE_MODULE, _this.cc.ccState.module, null, null, null, -1);
      ...
      lazyDispatch: function lazyDispatch(paramObj, payloadWhenFirstParamIsString, userInputDelay, userInputIdentity) {
        var d = dispatcher.__$$getDispatchHandler(_this.state, true, ccKey, ccUniqueKey, ccClassKey, _constant.STATE_FOR_ALL_CC_INSTANCES_OF_ONE_MODULE, _this.cc.ccState.module, null, null, null, -1);
