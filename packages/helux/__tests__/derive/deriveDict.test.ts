...
describe('derive dict', () => {
  test('derive shallow dict', async () => {
    ...
    const double = deriveDict(() => ({ num1: state.a * 2, num2: state.b * 2 }));
    const plus100 = deriveDict(() => ({ num1: double.num1 + 100, num2: double.num2 + 100 }));
  ...
  test('derive deep dict', async () => {
    ...
    const double = deriveDict(() => ({ num1: state.a.a1.a2 * 2, num2: state.b * 2 }));
    const plus100 = deriveDict(() => ({ num1: double.num1 + 100, num2: double.num2 + 100 }));
    expect(double.num1).toBe(2);
    expect(double.num2).toBe(4);
    expect(plus100.num1).toBe(102);
