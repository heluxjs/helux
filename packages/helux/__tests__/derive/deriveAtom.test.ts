...
describe('derive atom', () => {
  ...
  test('derive primitive', async () => {
    ...
    const plus100 = deriveAtom(() => double.val + 100);
  ...
  test('derive dict', async () => {
    ...
    const result1 = deriveAtom(() => ({ plus100: dictAtom.val.a + 100, plus200: dictAtom.val.a + 200 }));
    const result2 = deriveAtom(() => ({ plus100Double: result1.val.plus100 * 2, plus200Double: result1.val.plus200 * 2 }));
