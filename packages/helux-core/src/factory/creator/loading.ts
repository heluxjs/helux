import { FROM, HELUX_GLOBAL_LOADING, LOADING_MODE, STATE_TYPE } from '../../consts';
...
export function setLoadStatus(interal: TInternal, statusKey: string, status: LoadingStatus) {
  if (!statusKey) return;
