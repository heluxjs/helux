...
export var CC_FRAGMENT_PREFIX = '$$Fragment';
export var CC_DISPATCHER = '$$Dispatcher';
export var CC_DISPATCHER_BOX = '__cc_dispatcher_container_designed_by_zzk_qq_is_624313307__';
export var CHANGE_BY_SELF = 100;
export var CHANGE_BY_BROADCASTED_GLOBAL_STATE = 101;
export var CHANGE_BY_BROADCASTED_GLOBAL_STATE_FROM_OTHER_MODULE = 102;
export var CHANGE_BY_BROADCASTED_SHARED_STATE = 103;
export var CHANGE_BY_BROADCASTED_GLOBAL_STATE_AND_SHARED_STATE = 104;
export var BROADCAST_TRIGGERED_BY_CC_INSTANCE_METHOD = 300;
export var BROADCAST_TRIGGERED_BY_CC_INSTANCE_SET_GLOBAL_STATE = 301;
export var BROADCAST_TRIGGERED_BY_CC_API_SET_GLOBAL_STATE = 302;
export var BROADCAST_TRIGGERED_BY_CC_API_SET_STATE = 303; //  two kind of state extraction
//    cc will use ccInstance's sharedStateKeys and globalStateKeys to extract committed state  

export var STATE_FOR_ONE_CC_INSTANCE_FIRSTLY = 1; //    cc will use one module's sharedStateKeys and globalStateKeys to extract committed state  

export var STATE_FOR_ALL_CC_INSTANCES_OF_ONE_MODULE = 2;
export var ERR = {
