(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@babel/runtime/helpers/esm/inheritsLoose'), require('@babel/runtime/helpers/esm/assertThisInitialized'), require('react'), require('react-dom')) :
  typeof define === 'function' && define.amd ? define(['exports', '@babel/runtime/helpers/esm/inheritsLoose', '@babel/runtime/helpers/esm/assertThisInitialized', 'react', 'react-dom'], factory) :
  (factory((global.ReactControlCenter = {}),global._inheritsLoose,global._assertThisInitialized,global.React,global.ReactDOM));
}(this, (function (exports,_inheritsLoose,_assertThisInitialized,React,ReactDOM) { 'use strict';
        ...
        function (_TargetClass) {
          ...
          function CcClass(props, context) {
            ...
            try {
              ...
              util.bindThis(_assertThisInitialized(_assertThisInitialized(_this)), ['__$$mapCcToInstance', '$$changeState', '__$$recoverState', '$$domDispatch', '__$$getChangeStateHandler', '__$$getEffectHandler', '__$$getLazyEffectHandler', '__$$getXEffectHandler', '__$$getLazyXEffectHandler', '__$$getDispatchHandler', '__$$getEffectIdentityHandler', '__$$getXEffectIdentityHandler']);
          ...
          _proto.$$domDispatch = function $$domDispatch(event) {
            ...
            var handler = this.__$$getDispatchHandler(STATE_FOR_ONE_CC_INSTANCE_FIRSTLY, module, reducerModule, type, payload, cclazyms, ccKey, ccidt);
